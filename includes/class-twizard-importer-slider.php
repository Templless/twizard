...
if ( ! class_exists( 'Twizard_Importer_Slider' ) ) {

	/**
	 * Define Twizard_Importer_Slider class
	 */
	class Twizard_Importer_Slider {
		...
		function __construct() {
			...
			$slider_data = twiz()->get_setting( array( 'slider' ) );
		...
		public function slider_assets() {
			...
			wp_enqueue_script(
				'swiper-jquery',
				twiz()->url( 'assets/js/swiper.min.js' ),
				array( 'jquery' ),
				'2.0.0',
				true
			);
		...
		public function get_slides() {
			...
			$slides = get_transient( 'twizard_importer_slides' );
			...
			$this->slides = $slides;
			set_transient( 'twizard_importer_slides', $this->slides, DAY_IN_SECONDS );
...
/**
 * Returns instance of Twizard_Importer_Slider
 *
 * @return object
 */
function twiz_slider() {
	return Twizard_Importer_Slider::get_instance();
}
