...
if ( ! class_exists( 'Twizard_Importer_Session_Cache' ) ) {

	/**
	 * Define Twizard_Importer_Session_Cache class
	 */
	class Twizard_Importer_Session_Cache extends Twizard_Importer_Cache_Handler {
